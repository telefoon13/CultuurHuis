...
<table class="performancesTable">
    ...
    <jsp:useBean id="doneMap" scope="request" type="java.util.List"/>
...
<table class="performancesTable">
    ...
    <jsp:useBean id="failedMap" scope="request" type="java.util.List"/>
    <c:forEach var="failedMapa" items="${failedMap}" varStatus="status">
        <tr class="${status.index mod 2 eq 0 ? "tableLight" : "tableDark"}">
            ...
            <th>&euro; ${failedMapa.key.price}</th>
